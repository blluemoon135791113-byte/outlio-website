...
export const RESEARCH_FIELDS = [
  ...
  'insolvency_history',
  // Official SEC EDGAR company and filing facts
  'sec_cik',
  'sec_legal_name',
  'sec_entity_type',
  'sec_sic',
...
export const RESEARCH_FIELD_SPEC: Record<ResearchField, FieldSpec> = {
  ...
  sec_cik: { category: 'company_profile', entity: 'company' },
  sec_legal_name: { category: 'company_profile', entity: 'company' },
  sec_entity_type: { category: 'company_profile', entity: 'company' },
  sec_sic: { category: 'company_profile', entity: 'company' },
  sec_sic_description: { category: 'company_profile', entity: 'company' },
  sec_ein: { category: 'company_profile', entity: 'company' },
  sec_lei: { category: 'company_profile', entity: 'company' },
  sec_tickers: { category: 'company_profile', entity: 'company' },
  sec_exchanges: { category: 'company_profile', entity: 'company' },
  sec_state_of_incorporation: { category: 'company_profile', entity: 'company' },
  sec_business_address: { category: 'company_profile', entity: 'company' },

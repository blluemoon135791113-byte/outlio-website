...
const BOOK_ROWS: Book[][][] = [
  [
    ...
    [
      ...
      { color: '#ece5da', height: 86, tilt: -8 },
      { color: '#a8bcb5', height: 72 },
    ],
  ],
  [
    [
  ...
  [
    ...
    [
      ...
      { color: '#e3b77e', height: 71, tilt: 10 },
      { color: '#d9c9b7', height: 65 },
    ],
  ],
]
  ...
  return (
    <section className={styles.section} aria-labelledby="lead-library-title">
      <div className={styles.headingWrap}>
        <p className={styles.eyebrow}>Hubble Library</p>
        <h2 id="lead-library-title" className={styles.heading}>
          Its not that big. Just know where to look.
        </h2>
      </div>
      ...
      <div className={styles.libraryStage}>
        <div className={styles.shelfFrame} aria-label="Interactive lead intelligence library">
          <div className={styles.shelfInterior}>
            ...
            {BOOK_ROWS.map((compartments, rowIndex) => (
              <div className={styles.shelfRow} key={`row-${rowIndex}`}>
                {compartments.map((books, compartmentIndex) => (
                  <div className={styles.books} key={`compartment-${rowIndex}-${compartmentIndex}`}>
                    ...
                    if (!lead) {
                      return (
                        <span
                          ...
                          key={`book-${rowIndex}-${compartmentIndex}-${bookIndex}`}
                          style={bookStyle}
                        />
                      )
                    }

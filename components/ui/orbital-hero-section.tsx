...
export function OrbitalHeroSection({
  ...
  useEffect(() => {
    ...
    alignToCourse, apex, compress, driftSpeed, eccentricity, focus, glow,
    interactive, lead, maxTurns, paused, planeSpread, planets, roll, scrim,
    scrimStrength, showOrbits, showSunTrack, spin, starCount, sunColor,
    tilt, trailYears, viewRadius, yearSeconds,
  ]);

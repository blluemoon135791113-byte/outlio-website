  ...
  return (
    ...
    >
      {pending
        ...
        : `Export ${count.toLocaleString()} selected to HubSpot`}
    </button>
  )
}

export function HubSpotLeadExport({
  selectedLeadIds,
  hubSpotConnected,
  onSuccess,
}: {
  ...
  const [state, action] = useActionState(exportSelectedLeadsToHubSpotAction, INITIAL)
